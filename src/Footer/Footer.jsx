...
function Footer() {
	...
	return (
		<div className="navbar-home top-0 py-2 px-5 lg:py-5 w-full bg-transparent lg:relative z-50">
			<nav className="bg-transparent max-w-4xl xl:max-w-5xl mx-auto px-5 py-2.5 lg:border-none rounded-lg">
				<div className="flex items-center justify-between">
					<button>
						<div className="header-logo flex items-center space-x-2">
							<img src="/logo.png" alt="" />
							<h2 className="text-black font-bold text-base">
								ProductDesignerInWarsaw
							</h2>
						</div>
					</button>
					<div className="header-menu items-center gap-x-10">
						<ul className="flex space-x-10 text-sm font-bold text-black hover:text-black">
							<li>
